...
import pacman.model.entity.dynamic.player.observer.PlayerPositionAndDirectionObserver;
...
public class Pacman implements Controllable {
    ...
    private final Set<PlayerPositionAndDirectionObserver> observers;
    ...
    @Override
    public void registerObserver(PlayerPositionAndDirectionObserver observer) {
        this.observers.add(observer);
        observer.update(this.kinematicState.getPosition(), this.getDirection());
    }

    @Override
    public void removeObserver(PlayerPositionAndDirectionObserver observer) {
        this.observers.remove(observer);
    }

    public void notifyObservers() {
        for (PlayerPositionAndDirectionObserver observer : observers) {
            observer.update(this.kinematicState.getPosition(), this.getDirection());
        }
    }
